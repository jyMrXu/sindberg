...
photoBubbles.forEach(bubble => {
    ...
    hint.textContent = 'click to see more photos';
...
bubbles.forEach(bubble => {
    ...
    function createRefugeeChart() {
        ...
        jnFactoryText.textContent = 'Jiangnan Cement Plant';
        ...
        qxTempleText.textContent = 'Qixia Temple Buddhist Refugee Shelter';
